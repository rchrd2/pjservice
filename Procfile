...
web: phantomjs --debug=no --proxy=127.0.0.1:${PJSERVICE_PROXY_PORT:=8080} --disk-cache=no --load-images=false --web-security=false --ssl-protocol=any pjservice.js ${PJSERVICE_PORT:=1234}
